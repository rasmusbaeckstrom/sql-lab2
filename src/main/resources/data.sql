...
VALUES
    ('The Gourmet Bistro', 1, 'rasmus', TRUE, NOW(), 'A fine dining experience with a selection of international cuisines.', ST_GeomFromText('POINT(18.0686 59.3293)', 4326), NOW()),
    ('Pasta Paradise', 1, 'rasmus', TRUE, NOW(), 'An Italian restaurant famous for its handmade pasta.', ST_GeomFromText('POINT(18.0649 59.3326)', 4326), NOW()),
    ('Sushi World', 1, 'rasmus', FALSE, NOW(), 'Sushi and other Japanese delicacies prepared with fresh ingredients.', ST_GeomFromText('POINT(18.0708 59.3227)', 4326), NOW()),
    ('Veggie Delight', 1, 'rasmus', TRUE, NOW(), 'A vegetarian restaurant with a wide variety of plant-based dishes.', ST_GeomFromText('POINT(18.0721 59.3254)', 4326), NOW());
